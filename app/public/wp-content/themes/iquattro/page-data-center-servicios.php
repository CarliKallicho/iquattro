...
<main id="main" class="iq-main iq-dc-catalogo-page iq-dc-servicios-catalogo-page">
  ...
  <nav class="iq-dc-catalogo-nav" aria-label="<?php esc_attr_e('Navegación Data Center', 'iquattro'); ?>">
    <div class="iq-container">
      <a href="<?php echo esc_url($dc_software_url); ?>" class="iq-dc-catalogo-nav-btn iq-dc-catalogo-nav-btn--prev">
      ...
      <a href="<?php echo esc_url($dc_hardware_url); ?>" class="iq-dc-catalogo-nav-btn iq-dc-catalogo-nav-btn--next">
