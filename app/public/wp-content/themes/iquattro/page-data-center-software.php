...
<main id="main" class="iq-main iq-dc-catalogo-page">
  ...
  <nav class="iq-dc-catalogo-nav" aria-label="<?php esc_attr_e('Navegación Data Center', 'iquattro'); ?>">
    <div class="iq-container">
      <a href="<?php echo esc_url($dc_hardware_url); ?>" class="iq-dc-catalogo-nav-btn iq-dc-catalogo-nav-btn--prev">
        ...
        <span class="iq-dc-catalogo-nav-label"><?php esc_html_e('Hardware', 'iquattro'); ?></span>
      </a>
      <a href="<?php echo esc_url($dc_servicios_url); ?>" class="iq-dc-catalogo-nav-btn iq-dc-catalogo-nav-btn--next">
