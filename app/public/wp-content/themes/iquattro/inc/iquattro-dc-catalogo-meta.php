  ...
  $defaults = array(
    'data-center-hardware' => array(
      ...
      'cards' => array(
        ...
        array('icon' => 'hard-4.svg', 'title' => 'Data Center y Cableado Estructurado', 'items' => array('Energía', 'UPS', 'Cableado','Gabinetes Racks','Cámaras de Seguridad')),
        array('icon' => 'hard-5.svg', 'title' => 'Equipos de Redes y Comunicaciones', 'items' => array('Switches', 'Routers','Redes Inalámbricas')),
        array('icon' => 'hard-6.svg', 'title' => 'Mobility', 'items' => array('Celulares', 'Tablets')),
        array('icon' => 'hard-7.svg', 'title' => 'Seguridad', 'items' => array('Firewalls', 'Routers', 'Redes Inalámbricas', 'DDOS', 'ADC', 'WAF')),
        array('icon' => 'hard-8.svg', 'title' => 'Home Office', 'items' => array('Cámaras Web', 'Micrófono', 'Auriculares', 'Videoconferencia', 'Proyectores')),
      ),
    ),
