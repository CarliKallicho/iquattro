...
return array(
  ...
  'intervencion_title' => 'Cómo trabajamos en cada intervención',
  'intervencion_cards' => array(
    array('number' => '01', 'title' => 'Diagnóstico inicial', 'desc' => 'Relevamiento del entorno tecnológico del cliente e identificación de la situación actual.'),
    array('number' => '02', 'title' => 'Evaluación técnica', 'desc' => 'Análisis profundo de la plataforma, detección de riesgos, brechas y oportunidades de mejora.'),
    array('number' => '03', 'title' => 'Plan de acción', 'desc' => 'Diseño del plan de intervención con tareas, prioridades, tiempos y recursos asignados.'),
    array('number' => '04', 'title' => 'Implementación', 'desc' => 'Ejecución del soporte o proyecto minimizando el impacto en la operación productiva.'),
    array('number' => '05', 'title' => 'Optimización continua', 'desc' => 'Monitoreo post-intervención, ajustes finos y mejoras incrementales para maximizar resultados.'),
    array('number' => '06', 'title' => 'Reporte ejecutivo', 'desc' => 'Informe técnico con hallazgos, acciones realizadas, recomendaciones y documentación de cambios.'),
  ),
  'entregables_title' => 'Qué recibe el cliente en cada servicio',
  'entregables_cards' => array(
    array('icon' => 'file.svg', 'title' => 'Informe técnico detallado de la intervención realizada'),
    array('icon' => 'check.svg', 'title' => 'Checklist de seguridad y buenas prácticas (cuando aplica)'),
    array('icon' => 'signal.svg', 'title' => 'Recomendaciones de mejora priorizadas por impacto y esfuerzo'),
    array('icon' => 'case.svg', 'title' => 'Documentación completa de cambios realizados en la plataforma'),
    array('icon' => 'invoice.svg', 'title' => 'Reporte ejecutivo para alta dirección (en modalidad gestionada)'),
  ),
  'clientes_title' => 'Organizaciones que confían en iQuattro',
  'clientes_cards' => array(
    array('title' => 'Banco de Desarrollo Productivo', 'desc' => 'Banca · Soporte Oracle', 'pill' => 'Bolivia', 'pill_type' => 'bolivia'),
    array('title' => 'Agencia Nacional de Hidrocarburos', 'desc' => 'Gobierno · Soporte Oracle', 'pill' => 'Bolivia', 'pill_type' => 'bolivia'),
    array('title' => 'RUAT - Administración Tributaria Municipal', 'desc' => 'Gobierno Municipal · Oracle DB', 'pill' => 'Bolivia', 'pill_type' => 'bolivia'),
    array('title' => 'Movistar Ecuador', 'desc' => 'Telecomunicaciones · Soporte Oracle', 'pill' => 'Ecuador', 'pill_type' => 'ecuador'),
    array('title' => 'BANRED', 'desc' => 'Servicios Bancarios · Soporte Oracle', 'pill' => 'Ecuador', 'pill_type' => 'ecuador'),
    array('title' => 'Aguas Kpital', 'desc' => 'Servicios Públicos · Soporte Oracle', 'pill' => 'Colombia', 'pill_type' => 'colombia'),
  ),
