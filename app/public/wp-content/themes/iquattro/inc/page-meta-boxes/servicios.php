...
<div class="iq-page-meta-box" style="display:grid;gap:1.5rem;">
  ...
  <?php
  iquattro_page_meta_render_attachment_field('iq_page_hero_bg_id', __('Imagen de fondo del hero (por defecto: fondo-servicio.jpg)', 'iquattro'), $data['hero_bg_id']);
  ?>
  ...
  <?php
  iquattro_page_meta_render_attachment_field('iq_page_cta_side_bg_id', __('Imagen de fondo del costado (por defecto: fondo-servicios-costado.jpg)', 'iquattro'), $data['cta_side_bg_id']);
  ?>
